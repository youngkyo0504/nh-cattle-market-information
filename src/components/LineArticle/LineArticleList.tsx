                ...
                <tbody>
                  {data.data.map((cow, index) => (
                    <tr className=" bg-white text-table h-8   ">
                      <td className="text-gray-subtitle pb-[1.5rem]  pl-content pr-10   font-medium whitespace-nowrap ">
                        <span>{index + 1}</span>
                      </td>
                      <td className="pr-16 pb-[1.5rem] -tracking-[0.024rem]  w-4  font-medium text-blue whitespace-nowrap ">
                        <a
                          className="transition-all ease-out hover:bg-blue hover:text-white border-solid  border-blue text-blue pr-[21px] pl-[25px] py-1 border-[1.5px] rounded-3xl    "
                          target={"#"}
                      ...
                      <td className="pb-[1.5rem] font-medium pr-content  text-red whitespace-nowrap last:text-right -tracking-[0.5px]">
                        {cow.price}
                      </td>
                    </tr>
                  ))}
