...
const CattleMarketPriceContainer = () => {
  ...
  return (
    <article className=" mx-auto px-4 sm:px-0 sm:pb-14 sm:pt-8   md:max-w-full lg:max-w-9xl">
      <div>
        <div
          className={
            " mx-4 border-b-[1px] border-solid border-blue py-3 text-subtitle  font-bold text-blue sm:text-[1.688rem]  "
          }
        >
