            ...
            <div className="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-2" id="menu">
                <nav>
                    <ul className="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                      {links.map((link)=>(
                          <li><a className="inline-block no-underline hover:text-black hover:underline underline-offset-4 hover:decoration-2 py-2 px-4" href={link.src}>{link.name}</a></li>
                      ))}
                    </ul>
                </nav>
            </div>
