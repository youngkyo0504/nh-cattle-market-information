...
const Footer = () => {
  return (
    <footer >
      <div className=" items-center flex place-content-between text-center text-gray-700 p-4" style={{backgroundColor: 'rgba(0, 0, 0, 0.2)'}}>
      
        <div>
          Copyright © antller. All Rights Reserved 
          <a className="text-gray-800" href="https://tailwind-elements.com/">antller</a>
          </div>
